...
class Game:
    ...
    def __init__(self):
        ...
        self.game_speed = (
            0.09  # Controls how fast the snake moves (lower value = faster).
        )
        self.start_time = (
            time.time()
    ...
    def play_background_music(self):
        ...
        #         -1, 0
        #     )  # -1 means loop indefinitely, 0 is the starting position.
        # except pygame.error:
        #     print(
        #         "Warning: 'resources/bg_music_1.mp3' not found. Background music will not play."
        #     )
    ...
    def play_sound(self, sound_name):
        ...
        try:
            ...
            print(
                f"Warning: 'resources/{sound_name}.mp3' not found. Sound effect will not play."
            )
    ...
    def render_background(self):
        ...
        try:
            ...
            print(
                "Warning: 'resources/background.jpg' not found. Using solid background color."
            )
            self.surface.fill(
                BACKGROUND_COLOR
    ...
    def run(self):
        ...
        while running:
            ...
            if not pause:
                self.auto_control()
                # self.agent_bikram()  # Activate the random agent
    ...
    def auto_control(self):
        ...
        self.new_method(head_x, head_y, apple_x, apple_y)

    def new_method(self, head_x, head_y, apple_x, apple_y):
        if head_x > apple_x:
            self.snake.move_left()
        elif head_x < apple_x:
            self.snake.move_right()
